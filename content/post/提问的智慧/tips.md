---
title: 提问的智慧
description: 如何问出好的问题
date: 2025-01-19T21:25:32+08:00
image: 
math: 
license: 
hidden: false
...
---
# 前言
本人 `ISFJ`，非常乐意为大家解决问题，特别是一些技术问题。但是要知道，这种问题通常来说不是很好解决。但很遗憾的是，提问者通常不能提供解决问题所需的一些信息，以下是推荐所有人阅读的**提问的智慧**以及我自己的一些建议。同时，在帮他人解决问题时我也会尽力遵循[如何更好地回答问题](#如何更好地回答问题)
1. 选一个好一点的搜索引擎/AI。
2. 有问题直接问就好，看到了有想法，能解决自然会回复。
3. 代码有关的问题请带**报错、需求和源码**来。同时大家也应该学会看报错。
4. **少看CSDN。**
5. 别人在帮助你，请你接受他的好意。
# 提问的智慧
...
比方说，如果我回答你：```看来似乎是 zentry 卡住了；你应该先清除它。```，然后，这是一个 **_很糟的_** 后续问题回应：```zentry 是什么？```***好*** 的问法应该是这样：```哦~~~我看过说明了但是只有 -z 和 -p 两个参数中提到了 zentries，而且还都没有清楚的解释如何清除它。你是指这两个中的哪一个吗？还是我看漏了什么？```
